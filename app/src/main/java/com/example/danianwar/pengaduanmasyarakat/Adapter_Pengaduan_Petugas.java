...
public class Adapter_Pengaduan_Petugas extends RecyclerView.Adapter<Adapter_Pengaduan_Petugas.ViewHolder> {
    ...
    public Adapter_Pengaduan_Petugas(Context mContext, List<Entity_Pengaduan_Masyarakat> list){
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        holder.lr.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                bundle.putString("idPengaduan",list.get(position).getIdPengaduan());
                bundle.putString("foto",list.get(position).getFoto());
                bundle.putString("isi",list.get(position).getIsi_laporan());

                Intent inten = new Intent(mContext,Tanggapan.class);
